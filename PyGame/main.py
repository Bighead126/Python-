...
vlevo = False
ball = pygame.image.load('golf-ball-transparent-background-png.png')  # NAČTENÍ OBRÁZKU
...
ball_rect = ball.get_rect(center=(a, b))


screen.blit(ball, ball_rect)  # vykreslení rotovaného obrázku
